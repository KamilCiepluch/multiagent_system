...
-- =============================================================
-- SKILL: GRANICE ZAKRESU — search_agent nie obsługuje użytkowników
-- =============================================================
INSERT INTO agent_skills (agent_name, name, description, content) VALUES
(
    'search_agent',
    'granice-zakresu-wyszukiwania',
    'Co należy do search_agenta (informacje o danych), a co NIE (użytkownicy, role, uprawnienia).',
    $skill_s6$
PROCEDURA: Granice zakresu — czego search_agent NIE robi
...
- Nie zmyślaj roli ani statusu kontaktu na podstawie braku wyników.
$skill_s6$
)
ON CONFLICT (name) DO UPDATE
    SET agent_name  = EXCLUDED.agent_name,
